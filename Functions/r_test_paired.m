...
% La Jolla, CA, USA
% Compute correlations modified by Jonas Thiele
...
% changed to Spearman correlations:
r_jk=corr(j,k, 'type','Spearman');
r_jh=corr(j,h, 'type','Spearman');
r_kh=corr(h,k, 'type','Spearman');
